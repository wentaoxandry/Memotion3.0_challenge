...
def RAY_find(Datadir, cashedir, bestmodelinfo):
    ...
    #pretraineddir = os.path.join('/home/wentao/Desktop/Memotion3/RAY_results', 'RAY_pretrain_taskA_CLIP', 'training_2022-11-04_14-11-14',
    #                             'training_28e0f_00005_5_batch_size=2,lr=0.0002_2022-11-04_14-39-39',
