...
def main(datadir, savedir, cashedir):
    ...
    model = xgb.XGBClassifier(max_depth=max_depth, objective=objective,
    ...
    grid_search = GridSearchCV(model, param_grid, scoring="f1_macro", n_jobs=16)
    ...
    f1 = compute_f1(preds.tolist(), evalY.tolist())
    outputdict = {}
