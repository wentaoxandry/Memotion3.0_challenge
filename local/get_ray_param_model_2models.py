...
def find_ray(sourcedir):
    ...
    return [(list(keepdict)[0], best_model_info['lr'], best_model_info['dropout'], best_model_info['weight_decay'], best_model_info['batch_size'], best_model_info['gamma'], best_model_info['savedir']),
