...
def main(datadir, savedir, cashedir, type):
    ...
    for testkey in list(valdict.keys()):
        with open(os.path.join(datadir, 'XGBoosterfeat/taskC', type, testkey + '.npy'), 'rb') as f:
    ...
    for trainkey in list(traindict.keys()):
        with open(os.path.join(datadir, 'XGBoosterfeat/taskC', type, trainkey + '.npy'), 'rb') as f:
