...
class RetrievalDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        featuredir = self.imagefeatdata[featureid]['features']
        boxesdir = self.imagefeatdata[featureid]['boxes']
        image_h = self.imagefeatdata[featureid]['image_h']
        image_w = self.imagefeatdata[featureid]['image_w']
        ...
        od_labels = ' '.join(self.imagefeatdata[featureid]['labels'])
...
def main():
    ...
    traindir = os.path.join(args.data_dir, 'facebooktraingender.json')
    testdir = os.path.join(args.data_dir, 'facebooktestgender.json')
