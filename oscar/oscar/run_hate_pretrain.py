...
class RetrievalDataset(Dataset):
    ...
    def __init__(self, dataset, tokenizer, args, split='train', is_train=True):
        ...
        self.datadir = os.path.join(args.data_dir, 'fasterrcnn')
    ...
    def __getitem__(self, index):
        ...
        label = int(self.data[fileid]['taskA'])
...
def main():
    ...
    traindir = os.path.join(args.data_dir, 'pretrain_train_oscar.json')
    testdir = os.path.join(args.data_dir, 'pretrain_test_oscar.json')
